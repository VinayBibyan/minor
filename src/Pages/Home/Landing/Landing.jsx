  ...
  return (
    ...
    {/* Top Section */}
      <div className="top">
        <div className="left">
          <h1>
          Empowering Minds, Inspiring Futures: <br />Your Gateway to Online Learning with <span className="font-semibold text-amber-400 font-serif text-5xl">Adapt Learn</span>
          </h1>
          {/*  Search  */}
          ...
          <div className="search mb-10">
            ...
            <button className='w-32' onClick={handleSearch}>Find Lessons</button>
          </div>
        ...
        <div className="fets2">
          ...
          <NavLink to='/contact'>
            <div className="fet cursor-pointer">
              ...
              <p>
                We offer our students 24/7 live support. Whether its a question
